...
| [crucible](https://github.com/machug/crucible) | Multi-LLM adversarial project review. Evaluates progress, tech stack, code quality, CI/CD, and plan drift through parallel critique from multiple AI models. |
